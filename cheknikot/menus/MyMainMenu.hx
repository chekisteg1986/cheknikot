...
class MyMainMenu extends MenuBase
{
	...
	public function new() 
	{
		...
		erase_txt = new MyFlxText(0, 0, 0, ['Do you want to erase last save?','Хотите удалить последнее сохранение?','Бажаєте видалити останнє збереження?']);
		...
		for (s in erase) s.scrollFactor.set(0, 0);
